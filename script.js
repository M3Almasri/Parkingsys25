...
async function reserveSlot() {
  ...
  await fetch('http://localhost:5000/api/slots/reserve', {
    method: 'POST',
...
async function payForSlot(method) {
  ...
  await fetch('http://localhost:5000/api/slots/pay', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
async function unlockSlot() {
  ...
  await fetch('http://localhost:5000/api/slots/unlock', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ slot_id: slotId })
  });
...
async function releaseSlot() {
  ...
  await fetch('http://localhost:5000/api/slots/release', {
  method: 'POST',
  headers: {
